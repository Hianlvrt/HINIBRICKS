...
export const ComingSoon = ({ launchDate, onUnlock }: Props) => {
  ...
  return (
    <div className="min-h-screen bg-[#4a5ae4] flex flex-col items-center justify-center p-4 relative overflow-hidden">
